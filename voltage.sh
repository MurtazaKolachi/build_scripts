...
# --- Init ROM repo ---
repo init --depth=1 --no-repo-verify -u https://github.com/VoltageOS-staging/manifest.git -b 16 --git-lfs -g default,-mips,-darwin,-notdefault && \
...
# --- Clone Device Tree ---
rm -rf device/xiaomi
git clone https://github.com/MurtazaKolachi/android_device_xiaomi_apollo -b vos device/xiaomi/apollo && \
...
make installclean && \
mka bacon -j$(nproc --all) || { echo "Vanilla build failed. Stopping other builds..."; exit 1; } && \
