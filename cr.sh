...
# --- Init ROM repo ---
repo init -u https://github.com/Mi-Apollo/cr_android.git -b 16.0 --git-lfs && \
...
# --- Clone Device Tree ---
rm -rf device/xiaomi
git clone https://github.com/MurtazaKolachi/android_device_xiaomi_apollo -b crdroid device/xiaomi/apollo && \
