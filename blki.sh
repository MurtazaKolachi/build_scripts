...
# --- Init ROM repo ---
repo init --depth=1 -u https://github.com/Black-Iron-Project/manifest -b z16 --git-lfs && \
...
# --- Clone Device Tree ---
rm -rf device/xiaomi
git clone https://github.com/MurtazaKolachi/device_xiaomi_apollo -b blki device/xiaomi/apollo && \
