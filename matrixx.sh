...
# --- Init ROM repo ---
repo init --depth=1 -u https://github.com/ProjectMatrixx/android.git -b 16.2 --git-lfs && \
...
# --- Clone Device Tree ---
rm -rf device/xiaomi
git clone https://github.com/MurtazaKolachi/device_xiaomi_apollo -b matrixx device/xiaomi/apollo && \
