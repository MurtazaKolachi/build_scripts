...
repo init --depth=1 --no-repo-verify -u https://github.com/DerpFest-LOS/android_manifest.git -b 15.2 --git-lfs -g default,-mips,-darwin,-notdefault && \
/opt/crave/resync.sh && \
...
. build/envsetup.sh && \
lunch lineage_apollo-bp1a-user && make installclean && mka derp
