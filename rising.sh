...
# --- Init ROM repo ---
repo init --depth=1 --no-repo-verify -u https://github.com/RisingOS-Revived/android.git -b sixteen -g default,-mips,-darwin,-notdefault && \
...
riseup apollo user && \
make installclean && \
rise b -j$(nproc --all) || { echo "Vanilla build failed. Stopping other builds..."; exit 1; } && \
