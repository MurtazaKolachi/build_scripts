...
# --- Init ROM repo ---
repo init --depth=1 -u https://github.com/Project-MinusOS/manifest.git -b cirno --git-lfs && \
...
# --- Clone Device Tree ---
rm -rf device/xiaomi
git clone https://github.com/MurtazaKolachi/device_xiaomi_apollo -b minus device/xiaomi/apollo && \
...
echo "===== Starting Build ====="
touch "/tmp/build_active_${DEVICE}"
start_build_tracker "$START_MSG_ID" "$ROM_NAME" "$DEVICE" "Build"
