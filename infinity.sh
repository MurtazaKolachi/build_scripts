...
# --- Init ROM repo ---
repo init --depth=1 --no-repo-verify -u https://github.com/Mi-Apollo/infinity_manifest.git -b 15 --git-lfs && \

# --- Clone Manifest---
git clone https://github.com/MurtazaKolachi/build_manifest -b infinity .repo/local_manifests && \
