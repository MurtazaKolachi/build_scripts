...
# --- Init ROM repo ---
repo init --depth=1 --no-repo-verify -u https://github.com/Mi-Apollo/infinity_manifest.git -b 16 --git-lfs -g default,-mips,-darwin,-notdefault && \
...
make installclean && \
m bacon -j$(nproc --all) || { echo "Vanilla build failed. Stopping other builds..."; exit 1; } && \
