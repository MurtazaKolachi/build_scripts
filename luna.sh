...
# --- Clone Device Tree ---
rm -rf device/xiaomi
git clone https://github.com/MurtazaKolachi/device_xiaomi_apollo -b luna device/xiaomi/apollo && \
...
git clone https://github.com/MurtazaKolachi/keys -b test vendor/private-keys/keys && \
